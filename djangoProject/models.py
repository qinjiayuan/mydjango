...
class CounterpartyBenefitOverList(models.Model):
    client_id = models.TextField()  # This field type is a guess.
    name = models.TextField(blank=True, null=True)  # This field type is a guess.
    id_no = models.TextField(primary_key=True)  # This field type is a guess.
    ...
    class Meta:
        ...
        unique_together = (('id_no', 'client_id'),)
